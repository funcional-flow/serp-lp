        ...
        <div ref={fadeRef} className="absolute inset-0">
          <div className="absolute top-1/2 left-1/2 z-0 flex w-full -translate-x-1/2 -translate-y-1/2 items-center justify-center">
            <Image
              src={img_background}
              alt={img_background}
              width={w_img_background}
              height={h_img_background}
              draggable={false}
          ...
          <div className="relative flex h-svh w-full">
            ...
            >
              ...
              <div className="flex flex-col gap-2 pt-20 lg:gap-6 lg:pt-80">
                ...
                <p
                  className={`flex flex-col text-sm lg:text-base ${cor_textos2}`}
                >
            ...
            >
              ...
              <div className="relative mt-8 pt-5 pr-2">
                <div
                  className={`absolute -top-1.75 h-4 w-0.5 ${cor_detalhes}`}
                />
                <div
